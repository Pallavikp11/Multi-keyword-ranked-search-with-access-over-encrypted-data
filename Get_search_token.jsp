            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-2 active" href="Get_search_token.jsp">Search Token</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid tm-mt-60">
            <div class="row tm-mb-50">
                <div class="col-lg-12">
                    <br>
                    <center>
                        <h2 class="tm-text-primary ">Get Search Token</h2><br><br>
                    </center>
                    <table id="customers">
                        <th>User ID</th>
                        <th>Name </th>
                        ...
                        try {
                            ResultSet rs = st.executeQuery("Select * from du_reg where id = '" + uid + "'");
                            while (rs.next()) {
                    %>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-info" href="get_token.jsp?id=<%=rs.getString("id")%>&name=<%=rs.getString("name")%>&email=<%=rs.getString("email")%>">Get Token</a></td>
                        </tr>
                        <%                                        }
                            } catch (Exception ex) {
                                ex.printStackTrace();
