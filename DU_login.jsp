    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-2 active" href="DU_login.jsp">Data User</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid tm-mt-60">
            <div class="row tm-mb-50">
                <div class="col-md-6">
                    <center>
                        <img src="img/userlogin.jpg" width="450" height="350" />
                    </center>
                </div>
                <div class="col-md-6">
                    <br>
                    <center>
                        <h2 class="tm-text-primary ">Data User Login</h2><br><br>
                    </center>
                    <form id="contact-form" action="du_signin.jsp" method="POST" class="tm-contact-form mx-auto">
                        ...
                        <div class="form-group tm-text-right">
                            ...
                            <a href="du_signup.jsp" class="btn btn-primary">Register !</a>
                        </div>
                    </form>   
                </div> 
            </div>
