            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-2 active" href="Upload_file.jsp">Upload File</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid tm-mt-60">
            <div class="row tm-mb-50">
                <div class="col-md-4">
                    <center>
                        <br><br><br><br>
                        <img src="img/upload.png" width="350" height="250" />
                    </center>
                </div>
                <div class="col-md-6">
                    <br>
                    <center>
                        <h2 class="tm-text-primary ">Upload File</h2><br><br>
                    </center>

                    <form id="contact-form" action="upload" method="post" class="tm-contact-form mx-auto" enctype="multipart/form-data">
                        <div class="form-group">
                            <label><b>File Keyword :</b></label>
                            <input type="text" name="keyword" class="form-control rounded-0" minlength="8" placeholder="eg: Text Document" required="required" />
                        </div>
                        <div class="form-group">
                            <label><b>Select File :</b></label>
                            <input type="file" name="fileToUpload" class="form-control rounded-0" accept="text/plain" required />
                        </div>
                        <div class="form-group">
                            <label><b>File Access Policy :</b></label>
                            <select class="form-control" id="contact-select" name="access_policy" required>
                                <option value="">Select File Access Policy</option>
                                <option>Read</option>
