            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-2 active" href="req_files.jsp">Requested Files</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-lg-12">
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="approve.jsp?uid=<%=rs.getString("uid")%>&uname=<%=rs.getString("uname")%>&fileid=<%=rs.getString("fid")%>&filename=<%=rs.getString("filename")%>">Approve</a></td>
                        </tr>
                        <%                                        }
                            } catch (Exception ex) {
                                ex.printStackTrace();
