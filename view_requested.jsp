        ...
        <div class="container-fluid tm-mt-60">
            <div class="row tm-mb-50">
                ...
                <div class="col-md-6">
                    <br>
                    <center>
                        <h2 class="tm-text-primary ">Enter the Decryption Key</h2><br><br>
                    </center>
                    <%
                    ...
                    %>
                    <form id="contact-form" action="view_requested1.jsp" method="POST" class="tm-contact-form mx-auto">
                        <div class="form-group">
                            <input type="hidden" value="<%=fid%>" name="fid">
                            <input type="hidden" value="<%=time%>" name="time">
                            <input type="text" class="form-control" name="dkey" autocomplete="off" placeholder="Decryption Key">           
                        </div>	
