    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-2" href="DO_login.jsp">Data Owner</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-2" href="DU_login.jsp">Data User</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-2 active" href="Cloud_login.jsp">Cloud</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container-fluid tm-mt-60">
            <div class="row tm-mb-50">
                <div class="col-md-6">
                    <center>
                        <img src="img/cloud_login.jpg" width="450" height="350" />
                    </center>
                </div>
                <div class="col-md-6">
                    <br>
                    <center>
                        <h2 class="tm-text-primary ">Cloud Login</h2><br><br>
                    </center>

                    <form id="contact-form" action="cloud" method="POST" class="tm-contact-form mx-auto">
                        <div class="form-group">
                            <label><b>Email :</b></label>
                            <input type="text" name="name" class="form-control rounded-0" placeholder="Enter Your Email" required />
                        </div>
                        <div class="form-group">
